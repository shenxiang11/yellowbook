...
// Source: ./internal/repository/cache/interface.go

// Package codecachemocks is a generated GoMock package.
package codecachemocks
...
func (m *MockCodeCache) Verify(ctx context.Context, biz, phone, code string) error {
	m.ctrl.T.Helper()
